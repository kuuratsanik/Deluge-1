...
Ext.define('Deluge.details.StatusTab', {
    ...
    onRequestComplete: function(torrent) {
        ...
        seeds = torrent.total_seeds > -1 ? torrent.num_seeds + ' (' + torrent.total_seeds + ')' : torrent.num_seeds;
        ...
        completed_time = torrent.completed_time > 0.0 ? fdate(torrent.completed_time) : "Never";
        ...
        var data = {
            ...
            tracker_status: torrent.tracker_status, /* XXX */
        ...
        data.uploaded += ' (' + ((torrent.total_payload_upload) ? fsize(torrent.total_payload_upload): '0.0 KiB') + ')';
